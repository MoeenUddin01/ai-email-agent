...
export default function Home() {
  ...
  const handleLogin = async () => {
    if (isSigningIn) {
      console.log('Already signing in, preventing multiple calls');
      return;
    }
    ...
    try {
      ...
      if (error) {
        ...
        // The redirect will happen automatically, so we don't need to set isSigningIn to false
      }
    } catch (err) {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          <h1 className="text-4xl font-bold text-gray-900">AI Email Agent</h1>
          <p className="mt-2 text-gray-600">
            Intelligent email replies powered by AI and your knowledge base
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ul className="text-left space-y-2 text-gray-600">
              <li>✉️ Gmail integration</li>
              <li>🤖 AI-powered reply generation</li>
              <li>📚 RAG from your knowledge base</li>
              <li>✏️ Edit before sending</li>
